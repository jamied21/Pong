...
public class BallMovement : MonoBehaviour
{
    ...
    void PositionBall(bool isStartingPlayer1) {
        ...
        //Changes side the ball starts on depending on which player won the round
    ...
    public IEnumerator StartBall(bool isStartingPlayer1 = true) {
        ...
        this.hitCounter = 0;
        //Wait for 2 seconds once the hit counter is set to 0
        //Then the ball movement will start
